...
class KotlinLandMarkApp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = KotlinLandmarkAdapter(arraylist)
        binding.recylerViewLandMark.layoutManager = LinearLayoutManager(this)
        binding.recylerViewLandMark.adapter = adapter
